			...
			<div class="mypage-content">
				...
				<div class="mypage-content-detail">
					...
					<table class="mypage-table table-text-center">
						<form action="/updateForm" name="updateForm" id="updateForm"
							method="POST">
							...
							<div class="content">
								...
								<div class="input-wrap">
									...
									<div>
										<label class="required">*</label> <i class="bi-key"></i> <input
											class="user-info-input" type="password" name="userPw"
											id="userPw" placeholder="비밀번호(공백X 특문X 4~18글자)">
									</div>
									<div>
										<label class="required">*</label> <i class="bi-check"></i> <input
											class="user-info-input" type="password" name="userPwCheck"
											id="userPwCheck" placeholder="비밀번호 확인">
									</div>
								</div>
								...
								<div class="input-wrap">
									...
									<div>
										<label class="required">*</label> <i class="bi-telephone"></i>
										<input class="user-info-input" name="phone" id="phone"
											placeholder="전화번호(숫자 11자리)" value="0${user.phone}"
											style="color: #808080"> <select
											class="select-box float-right" name="tongsin" id="tongsin">

										</select>
									</div>
									<div>
										<label class="required">*</label> <i class="bi-mailbox"></i> <input
											class="user-info-input" type="email" name="email" id="email"
											placeholder="[선택] 비밀번호 분실 시 확인용 이메일" value="${user.email}"
											style="color: #808080">
									</div>
									<div>
										<label class="required">*</label> <i class="bi-signpost"></i>
										<input class="user-info-input" type="text" name="basicAddr"
											id="basicAddr" placeholder="주소" value="${user.basicAddr}"
											style="color: #808080" readonly="readonly"> <input
											class="input-right" type="button" onclick="addressSearch();"
											value="주소검색">
									</div>
									<div>
										<label class="required">*</label> <i class="bi-signpost"></i>
										<input class="user-info-input" type="text" name="detailAddr"
								...
								<br>
								<button class="long-btn bg-dark" onclick="updateCheck();"
									type="button">수정완료</button>

							</div>
							<tr>
								<td colspan="2"><input class="change-option-btn"
									type="button" value="회원탈퇴" onclick="withdrawal()"></td>
							</tr>
						</form>
					</table>
				</div>
