...
<body onload="toLocaleString();">
    <div class="nav-and-content">
            ...
            <section class="py-5">
                <div class="container px-4 px-lg-5 my-5">
                    <div class="row gx-4 gx-lg-5 align-items-center">
                        <div class="col-md-6">
                            <img class="card-img-top mb-5 mb-md-0" src="../resources/image/productimage/${products.productCode}.png" alt="..." />
                        </div>
                        <div class="col-md-6">
                    ...
                    <c:forEach var="review" items="${reviews}">
                        <div class="reviewContainer">
                            <div class="review">
                                ...
                                <!-- 리뷰 삭제 버튼 -->
                               <button class="btn btn-danger" onclick="deleteReview(${products.productCode}, ${review.reviewNo})">삭제</button>
                            </div>
                            <hr class="reviewSeparator">
                        </div>
                    </c:forEach>
        ...
        <script>
            ...
            function deleteReview(productCode, reviewNo) {
                if (confirm("정말 이 리뷰를 삭제하시겠습니까?")) {
                    // AJAX를 통해 리뷰 삭제 요청 보내기
                    axios({
                        method: "post",
                        url: `/productdetail/${productCode}`, // "/delete"를 추가하여 POST 요청 보내도록 수정
                        params: { reviewNo: reviewNo } // reviewNo를 요청 매개변수로 전달
                    })
                    .then((response) => {
                        if (response.status === 200) {
                            alert("리뷰가 삭제되었습니다.");
                            // 페이지 새로고침하여 삭제된 리뷰 목록 다시 보여주기
                            location.reload();
                        }
                    })
                    .catch((error) => {
