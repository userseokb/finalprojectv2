	...
	<div class="nav-and-content">
		...
		<div class="container">
			...
			<div id="product_order_list" style="margin-right: 8em;">
				<p align="right">
					<a href="/main/recentlist">최신순</a>&nbsp&nbsp&nbsp|&nbsp&nbsp&nbsp <a
						href="/main/pricelist">낮은가격</a>&nbsp&nbsp&nbsp|&nbsp&nbsp&nbsp <a
						href="/main/pricelistdesc">높은가격</a>
				</p>
			</div>
						...
						<div class="col mb-5">
							<div class="card h-100">
								...
								<img class="card-img-top"
									src="../resources/image/productimage/${product.productCode}.png"
									alt="..." />
								<!-- Product details-->
								...
								<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
									<div class="text-center">
										<a class="btn btn-outline-dark mt-auto"
											href="/productdetail/${product.productCode}">상세보기</a>
									</div>
								</div>
							</div>
						</div>
				...
				<div>
					<nav class="page navigation">
						<ul class="pagination justify-content-center">
							...
							<c:forEach var="num" begin="${pageInfoSort.startPage}"
								end="${pageInfoSort.endPage}">
								<li
									class="page-item ${pageInfoSort.pageRequest.pageNum == num ? "active" : "" } ">
									<a class="page-link"
				...
				<div>
					<nav class="page navigation">
						<ul class="pagination justify-content-center">
							...
							<c:forEach var="num" begin="${searchInfo.startPage}"
								end="${searchInfo.endPage}">
